...
<head>
    ...
    <link rel="stylesheet" href="/css/stylekepdis.css">
        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse navbar-dark navbar-hover" id="navbarSupportedContent">
                    <a class="nav-link active" aria-current="page" href="<?= base_url('lamanutamakepdis'); ?>"><img alt="Dinas Perindustrian dan Perdagangan Kabupaten Pamekasan" src="<?= base_url('../asset/pemkabsipp.png'); ?>" width="60px" height="40px" style="margin-right: -20px;"></a>
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('cekindustri'); ?>">Informasi Industri</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('cekhitung'); ?>">Cek Hasil Perhitungan</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="<?= base_url('cekranking'); ?>">Cek Hasil Perankingan</a>
                        </li>
                        
                    </ul>
                    <form action="/logout-kepdis" method="post" class="d-flex" role="search">
