...
<div class="container">
    <div class="row">
        <div class="col mt-3">
            <button class="btn btn-outline-light rounded-circle" id="kembali" name="kembali" onclick="history.go(-1)"><span class="fa-solid fa-chevron-left"></span></button>
        </div>
    </div>
    <div class="row">
        <div class="col">
            ...
            <table class="table table-responsive table-hover text-nowrap">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th style="white-space:nowrap;" scope="col">Role Pengguna</th>
                    ...
                    <?php foreach ($request as  $value) : ?>
                        ...
                        <?php } else { ?>
                            <tr style="font-weight: light;">
                                ...
                                <?php endforeach; ?>
                                <td>
                                    <a href="/lihat-request-industri-kepdis/<?= $value['idreq']; ?>" class="btn btn-primary fa-solid fa-eye-slash"></a>
                                        </td>
                            </tr>
                        <?php } ?>
                    <?php endforeach; ?>
