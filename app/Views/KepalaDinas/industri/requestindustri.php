...
<div class="container mt-4 mb-4">
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <button type="button" class="btn btn-light rounded-circle" title="Kembali" onclick="history.go(-1)"><span class="fa-solid fa-chevron-left"></span></button>
                </div>
            </div>
            ...
            <div class="row mb-3 mt-3">
                <div class="col">
                    <h1>Request Data Industri</h1>
                    <h5>Deskripsi :</h5>
                    <p>Form ini merupakan form yang digunakan untuk meminta request data industri kepada Administrator sistem agar data industri kreatif dapat ditampilkan.</p>
                    <hr>
                </div>
            </div>
            <form action="/request-data">
                ...
                <div class="row mb-3 mt-3">
                    ...
                    <div class="col-lg-10">
                        <input type="text" id="subject" name="subject" class="form-control" placeholder="Masukkan Subject Request Anda" disabled value="request_industri">
                    </div>
                </div>
