...
class Kalkulasi extends BaseController
{
    ...
    public function index()
    {
        ...
        // $kategori = $daftarkategori->getCategoryData();
        ...
        foreach ($dataID as $nilaiarrayIDNIB) {
            ...
            if (isset($DataBobot[$dataNIB])) {
                $merged[$dataNIB] = $nilaiarrayIDNIB + $DataBobot[$dataNIB];
            }
            $arraylengkap = $merged;
        }
        ...
        $data = [
            'judul' => 'Laman Perhitungan | Dinas Perindustrian dan Perdagangan Kabupaten Pamekasan',
            'datatabel' => $arraylengkap,
            'kolom' => $kolom
        ];
        return view('/admin/kalkulasi/calculation', $data);
    }
    ...
    public function moora()
    {
        ...
        // $perpindahanelemen1 = $TabelBobotAwal[2];
        // unset($TabelBobotAwal[2]);
        // array_splice(
        //     $TabelBobotAwal,
        //     7,
        //     0,
        ...
        // Perulangan array data variabel
        #Tabel bobot entropy
        $Bobotentropy = [];
    ...
    public function UpdateBobot($bobot, $idkriteria)
    {
        $db = db_connect();
        $sql = $db->query("UPDATE ON penilaian SET nilai='$bobot' WHERE idkriteria='$idkriteria'");
        return true;
    }
